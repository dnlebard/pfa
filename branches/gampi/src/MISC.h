      ...
      logical rprmok,wprmok,rcrdok,wcrdok,rcvdok,rcvbok,wnmrok
      logical save,match,match2,inlist,lespert
      logical find,allmas,bigmas,lreal(maxnatom),
     .        treal(maxnatom)
      integer dscale,ascale,bscale
      logical nomodv
     ...
     .        tang2(maxangt)
      ...
      common /misc7i/ dscale,ascale,bscale
      common /misc1r/ x,y,z,vx,vy,vz,lesfac,ochrg,ocgper,omass,crdbox
      common /misc2r/ box1,box2,newm
      common /misc1l/ rcrdok,allmas,bigmas,lespert,lreal,treal
      common /misc2l/ rcvdok,rcvbok,nomodv
      common /misc1c/ crdline
